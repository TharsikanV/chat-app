    ...
    <div className='fixed top-0 bottom-0 left-0 right-0 bg-gray-700 bg-opacity-40 flex justify-center items-center'>
      <div className='bg-white p-4 py-5 m-1 rounded w-full max-w-sm'>
        ...
        <form className='grid gap-3 mt-3' onSubmit={handleSubmit}>
          ...
          <div>
            <button className='border-primary border text-primary px-4 py-1 rounde'>Cancel</button>
            <button className='border-primary  bg-primary  text-white border px-4 py-1'>Save</button>
          </div>
