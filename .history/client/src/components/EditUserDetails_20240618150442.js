      ...
      <div className='bg-white p-4 py-5 m-1 rounded w-full max-w-sm'>
        ...
        <form className='grid gap-3 mt-3' onSubmit={handleSubmit}>
          ...
          <div className='flex gap-2 w-fit ml-auto '>
            <button className='border-primary border text-primary px-4 py-1 rounded hover:bg-primary hover:text-white'>Cancel</button>
            <button className='border-primary  bg-primary  text-white border px-4 py-1 rounded hover:'>Save</button>
          </div>
